...
TODO:
1. Создать ветку 'L2SHW' и в этой ветке вынести методы Итераторов и Элемента за пределы класса;

DONE:
1. Закончить вынос методов 'ForwardList' за пределы класса (остался только класс 'Element');
2. Если все заработало, сделть COMMIT;
3. Создать ветку 'SeparatedList2HW';
4. В ветке 'SeparatedList2HW', вынести все методы класса 'List' (двусвязный список) и его смежных классов
   за пределы классов;

DONE:
1. Проверить шаблонный двусвязный список на типах данных 'double', 'char' и 'char*';
